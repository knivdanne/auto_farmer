...
// Polyroll
const MASTERCHEF_ADDRESS = '0x1c9Bb05f905e15E8d6428f69e58b35811B62f7ab';
const ROUTER_ADDRESS = '0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff';
// Roll token
const poolid = web3.utils.toBN(19)
...
const ROLL_ADDRESS = '0x831753DD7087CaC61aB5644b308642cc1c33Dc13'; //Actually Quick

const WMATIC_ADDRESS = '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270';

const amountIn = web3.utils.toWei('0');

module.exports = async done => {
  try {
    const [admin, _] = await web3.eth.getAccounts();
    console.log(admin);
    const masterchef = await MasterChef.at(MASTERCHEF_ADDRESS);
    ...
    // const balanceRollBefore = await roll.balanceOf(admin);
    // console.log(balanceRollBefore);
    // await roll.deposit({value: amountIn}) 
    // await roll.approve(masterchef.address, amountIn);
    // await roll.approve(router.address, amountIn);
    await masterchef.deposit(
      poolid,
      amountIn
    );

    // const balanceRollAfter = await roll.balanceOf(admin);

    // console.log(balanceRollBefore);
    // console.log(balanceRollAfter);
